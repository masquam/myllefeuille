  ...
  KnowledgeFTS
    ...
    .exec(function (err, docs) {
      if (err) {
        ...
        callback(err, res, searchstring, null);
      }
      ftsToKnowledges(docs, res, searchstring, callback);
    });
}

function ftsToKnowledges(docs, res, searchstring, callback){
  var docsIdArray = [];
  ...
  Knowledge.find(
    ...
    function (err, listKnowledge) {
      ...
      callback(null, res, searchstring, listKnowledge);
    });
}
